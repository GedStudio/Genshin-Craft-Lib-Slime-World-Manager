package net.deechael.genshin.lib.impl.world.loaders.file;

import net.deechael.genshin.lib.impl.world.SlimeManagerImpl;
import net.deechael.genshin.lib.open.world.config.FileConfig;
...
public class FileLoader implements SlimeLoader {
    ...
    public FileLoader(File worldDir) {
        ...
        if (worldDir.exists() && !worldDir.isDirectory()) {
            SlimeManagerImpl.getPlugin().getSLF4JLogger().warn("A file named '" + worldDir.getName() + "' has been deleted, as this is the name used for the worlds directory.");
            worldDir.delete();
        }
    ...
    public FileLoader(FileConfig config) {
        this(new File(config.getPath()));
    }
