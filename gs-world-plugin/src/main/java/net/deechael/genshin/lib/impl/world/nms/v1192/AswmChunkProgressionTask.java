package net.deechael.genshin.lib.impl.world.nms.v1192;
...
public final class AswmChunkProgressionTask extends ChunkProgressionTask {
    ...
    private AswmChunkProgressionTask(final ChunkTaskScheduler scheduler, final ServerLevel world, final int chunkX, final int chunkZ,
    ...
    public final class ChunkDataLoadTask implements PrioritisedExecutor.PrioritisedTask {
        ...
        private final Consumer<Either<ChunkAccess, Throwable>> onRun;
